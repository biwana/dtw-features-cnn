...
def read_data_sets(train_file, train_label, shape, test_file="", test_label="", test_ratio=0.1, validation_ratio=0.0, pickle=True, boring=False, onehot=False, fold=0):
    ...
    if (pickle):
        ...
        if test_file:
            ...
            trainset = indices
            test_images = train_images[testset]
            test_labels = train_labels[testset]
            train_images = train_images[trainset]
